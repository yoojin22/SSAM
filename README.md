...
| <img src="image/학급등록수락.gif" alt="학급 등록 수락" width="400px" /> |    <img src="image/학생_-_학급_입장.gif" alt="학급 등록" width="400px">    |
|                                            <b>문의 사항 답변</b>                                            |                                             <b>문의 사항 작성</b>                                              |
|  <img src="image/질문_답변.gif" alt="문의 사항 답변" width="400px" />   | <img src="image/학부모_문의사항.gif" alt="문의 사항 작성" width="400px" /> |
...
| :-----------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------: |
|                                         <b>상담 수락 </b>                                         |                                         <b>상담 신청</b>                                          |
| <img src="image/상담신청.gif" alt="상담 수락" width="400px"/> | <img src="image/상담신청.gif" alt="상담 신청" width="400px"/> |

|                                               상담 일정 확인                                                |                                                 상담 거부 날짜 설정                                                 |
| :---------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------: |
| <img src="image/상담목록확인.gif" alt="상담 일정 확인" width="400px" /> | <img src="image/선생님_상담신청.gif" alt="상담 거부 날짜 설정" width="400px" /> |

|                                              상담 입장                                              |
| :-------------------------------------------------------------------------------------------------: |
| <img src="image/상담_입장.gif" alt="상담 입장" width="600px" /> |
...
|                                                 상담 화면                                                  |
| :--------------------------------------------------------------------------------------------------------: |
<!-- | <img src="image/화상상담_-_2배속.gif" alt="상담 화면" width="600px" /> | -->

### 상담 요약 확인

|                                             상담 요약 확인                                              |
| :-----------------------------------------------------------------------------------------------------: |
| <img src="image/상담요약.gif" alt="상담 요약 확인" width="600px" /> |
...
| <img src="image/선생님_-_gpt_학습.gif" alt="공지사항 추가" height="400px" /> | <img src="image/학부모_챗봇.gif" alt="챗봇 문의" height="400px" /> |
  ...
  <tr>
    <td align="center" width="120px">
      <a href="" target="_blank">
        <img src="image/image.png" alt="프로필" />
      </a>
    </td>
    <td align="center" width="120px">
      <a href="" target="_blank">
        <img src="image/박범준프사.png" alt="프로필" />
      </a>
    </td>
    <td align="center" width="120px">
    ...
    <td align="center" width="120px">
      <a href="" target="_blank">
        <img src="image/권혜경프사.jpg" alt="권혜경프로필" />
      </a>
    </td>
    <td align="center" width="120px">
      <a href="" target="_blank">
        <img src="image/장효승프사.jpg" alt="장효승프로필" />
      </a>
    </td>
    <td align="center" width="120px">
      <a href="" target="_blank">
        <img src="image/정종화프사.jfif" alt="정종화프로필" />
      </a>
    </td>
  </tr>
  <tr>
...
<img src="image/시스템_아키텍처_최x7종.png" width="1000px" alt="시스템 아키텍처 이미지">
